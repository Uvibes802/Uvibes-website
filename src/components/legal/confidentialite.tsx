  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>
          Les seules données collectées par le site Uvibes.fr sont celles que
          vous renseignez en remplissant le formulaire de contact.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          collectées, ou selon les obligations légales en vigueur.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Toutefois, aucune transmission sur Internet ou méthode de stockage
